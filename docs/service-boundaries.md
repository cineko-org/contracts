...
| CatalogService | submit a catalog snapshot or an authenticated Client live-seat observation | catalog, auditoriums, seat-map resolution, seat-map state stream | Central catalog |
