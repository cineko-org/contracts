...
`docs/central-probe.md`. Runtime state and retries are defined in `docs/probe-runtime.md`, catalog/observation mutation
in `docs/catalog-observation.md`, and local proxy lifecycle in `docs/egress.md`.
